...
namespace Service
{
    ...
    public static class DatabaseExtensions
    {
        ...
        private static IDbConnection DefaultConnection
        {
            get
            {
                return Model.MyConfig.DefaultConnection;
            }
        }
        /// <summary>
        ...
        private static string DefaultConnectionString
        {
            get
            {
                return Model.MyConfig.DefaultConnectionString;
            }
        }
        /// <summary>
        /// 动态查询主方法
                ...
                params object[] parameters)
        {
            ...
            using (IDataReader dataReader = cmd.ExecuteReader())
            {
                ...
                //2、DataReader转换Json
                string jsonstr = Commons.JsonHelper.JsonConverter.ToJson(dataReader);
                dataReader.Close();
                dataReader.Dispose();
                cmd.Dispose();
                conn.Close();
                conn.Dispose();
                //3、Json转换动态类
                dynamic dyna = Commons.JsonHelper.JsonConverter.ConvertJson(jsonstr);
                return dyna;
            }
        }
        /// <summary>
